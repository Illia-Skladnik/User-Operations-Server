        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                switch (foundRole) {
                    ...
                    case 'boss':
                        {
                            subordinatesId_1 = foundUser.subordinatesId;
                            subordinates = allUsers.filter(function (user) { return subordinatesId_1.includes(user.id); });
                            return [2 /*return*/, __spreadArray([foundUser], subordinates, true)];
                        }
                        ;
                    default:
